 ...
 * the force transmitted is scaled by the ratio. The pulley also enforces a
 * maximum length limit on both sides. This is useful to prevent one side of the
